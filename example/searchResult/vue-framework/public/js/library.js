    ...
    var Component = (function (isUndefined) {
        ...
        Component.prototype = {
            ...
            setOpts: function () {
                ...
                if (!this.opts.frameworkRender) {
                    this.$inner.css('height', optHeight * Math.ceil(this.opts.datas.length / this.opts.col));
                } else {
                    this.outCallback('frameworkHeight', {
                        h: optHeight * Math.ceil(this.opts.datas.length / this.opts.col)
                    });
                }
            },
            changeEvents: function (event) {
            ...
            buildLayout: function (min, max) {
                ...
                if (this.prevTranslateY != currentTranslateY) {
                    if (!this.opts.frameworkRender) {
                        ...
                        this.outCallback('frameworkTransform', {
                            y: currentTranslateY
                        });
                    }
                }
                ...
                if (this.prevMin != min) {
                    if (!this.opts.frameworkRender) {
                        ...
                        this.outCallback('frameworkRender', {
                            min: min,
                            max: max
                        });
            ...
            outCallback: function (ing, param) {
