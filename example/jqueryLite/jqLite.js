/*!
 * jQuery JavaScript Library v1.12.4 -ajax,-ajax/jsonp,-ajax/load,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated/ajax-event-alias
 * https://jquery.com/
 *
...
( function( global, factory ) {
	...
	if ( typeof module === "object" && typeof module.exports === "object" ) {
		...
		// e.g. var jQuery = require("jqLite")(window);
		// See ticket #14549 for more info.
		module.exports = global.document ?
			factory( global, true ) :
			function( w ) {
				if ( !w.document ) {
					throw new Error( "jqLite requires a window with a document" );
				}
				return factory( w );
			};
	} else {
...
var version = "1.12.4 -ajax,-ajax/jsonp,-ajax/load,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated/ajax-event-alias",
...
jQuery.extend( {
	...
	expando: "jqLite" + ( version + Math.random() ).replace( /\D/g, "" ),
...
jQuery.Deferred.exceptionHook = function( error, stack ) {
	...
	if ( error && rerrorNames.test( error.name ) ) {
		window.console.warn(
			"jqLite.Deferred exception: " + error.message,
			error.stack,
			stack
		);
	}
...
var
	...
	_jQuery = window.jqLite;

jQuery.noConflict = function( deep ) {
	if ( deep && window.jqLite === jQuery ) {
